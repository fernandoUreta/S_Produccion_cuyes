...
public class ConsultarUsuario extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (acct != null) {
            ...
            //Picasso.get().load("https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/styles/480/public/media/image/2019/03/Naruto%20Shippuden.jpg?itok=j01yZmvd").placeholder(android.R.drawable.sym_def_app_icon).error(android.R.drawable.stat_notify_error).into(imagen);
            //Picasso.get().load(personPhoto).placeholder(android.R.drawable.sym_def_app_icon).error(android.R.drawable.stat_notify_error).into(imagen);
            Picasso.get().load(String.valueOf(personPhoto)).into(imagen);
