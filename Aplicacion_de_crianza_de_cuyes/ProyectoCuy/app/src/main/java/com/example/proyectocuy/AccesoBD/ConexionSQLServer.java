...
public class ConexionSQLServer {
    ...
    public static Connection conectarBD(){
        ...
        try {
            ...
            //Conexion AZURE
            //cnn= DriverManager.getConnection("jdbc:jtds:sqlserver://appcuyes.database.windows.net:1433;database=BDProduccionCuyes;user=usuario@appcuyes;password=cuyes1000%;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
