...
public class ExpPCAdapterPad extends BaseExpandableListAdapter {
    private ArrayList<String> listCategoria;
    private Map<String,ArrayList<String>> mapChild;
    private Context context;
    private ArrayList<Poza> mList;

    public ExpPCAdapterPad(ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChild, Context context) {
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView=LayoutInflater.from(context).inflate(R.layout.elv_child3,null);
        ...
        tvCantMaA.setText(String.valueOf(BD_AccesoDatos.consultarCantiTipoCuyPoza(listCategoria.get(groupPosition),"PD")));
