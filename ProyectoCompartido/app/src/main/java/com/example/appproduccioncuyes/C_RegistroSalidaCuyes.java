...
import com.example.appproduccioncuyes.Utilidades.Transacciones;
import com.example.appproduccioncuyes.ModeloDatos.*;
...
public class C_RegistroSalidaCuyes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_salida_cuyes_a_pozas);
        ...
        //transaccion=Transaccion.
                //Transacciones.generarTransaccion(usuarioID);
    ...
    private Cuy capturarCuy()
    {
        ...
        cuy.setFechaNaci(com.example.proyectocuy.Recursos_Adicionales.Fechas.calcularFechaNacimiento(Integer.parseInt(txtEdad.getText().toString())));
